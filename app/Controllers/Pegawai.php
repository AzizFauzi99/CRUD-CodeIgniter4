...
class Pegawai extends BaseController
{
    ...
    public function simpan()
    {
		...
		if ($validasi->withRequest($this->request)->run()) {
            // Menangkap data dari pegawai_view.php
    ...
    public function index()
    {
        ...
        $data['dataPegawai'] = $pencarian->orderBy('id','desc')->paginate($jumlahBaris); //->findAll();
		$data['pager'] = $pencarian->pager;
		$data['nomor'] = ($this->request->getVar('page')== null) ? '1' : $this->request->getVar('page');
